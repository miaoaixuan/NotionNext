...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '27a4cea1b73e8049a28ccb650be3624a',
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  THEME: process.env.NEXT_PUBLIC_THEME || 'chenge', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LinkStar', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '以天地为物，筑星辰大海之梦', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.miaoaixuan.cn', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备2021073404号-1', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_ORDER: process.env.NEXT_PUBLIC_MUSIC_PLAYER_ORDER || 'random', // 默认播放方式，顺序 order，随机 random
  MUSIC_PLAYER_AUDIO_LIST: [{"title":"轻音乐","list":["https://music.163.com/#/playlist?id=919444742"]},{"title":"治愈民谣","list":["https://music.163.com/#/playlist?id=559992539"]}],
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.chenge.ink', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'kvjor7yivu', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '尘世の歌', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '近城远山，皆是人间。', // 站点描述，被notion中的页面描述覆盖
