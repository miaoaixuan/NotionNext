...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '陈源泉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '心有山海，静而无边。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chenge.ink', // 网站地址
